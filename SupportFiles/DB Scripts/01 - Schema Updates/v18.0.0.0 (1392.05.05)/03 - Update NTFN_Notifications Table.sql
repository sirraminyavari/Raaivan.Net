...
CREATE TABLE [dbo].[NTFN_TMPNotifications](
 ...
 CONSTRAINT [PK_NTFN_TMPNotifications] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
...
INSERT INTO [dbo].[NTFN_TMPNotifications](
	UserID,
	SubjectID,
	RefItemID,
	SubjectType,
...
SELECT UserID, SubjectID, RefItemID, SubjectType, SubjectName, [Action], SenderUserID,
	SendDate, [Description], Seen, ViewDate, Deleted
FROM [dbo].[NTFN_Notifications]

GO


DROP TABLE [dbo].[NTFN_Notifications]
GO
...
FROM [dbo].[NTFN_TMPNotifications]

GO


DROP TABLE [dbo].[NTFN_TMPNotifications]
GO