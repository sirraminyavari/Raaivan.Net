(function () {
    if (((window.ReportOptions || {}).KW || {}).KnowledgeEvaluationsDetailReport) return;
    window.ReportOptions = window.ReportOptions || {};
    window.ReportOptions.KW = window.ReportOptions.KW || {};

    window.ReportOptions.KW.KnowledgeEvaluationsDetailReport = function (containerDiv, params, done) {
    ...
    ReportOptions.KW.KnowledgeEvaluationsDetailReport.prototype = {
