(function () {
    if (((window.ReportOptions || {}).CN || {}).MostFavoriteNodesReport) return;
    window.ReportOptions = window.ReportOptions || {};
    window.ReportOptions.CN = window.ReportOptions.CN || {};

    window.ReportOptions.CN.MostFavoriteNodesReport = function (containerDiv, params, done) {
    ...
    ReportOptions.CN.MostFavoriteNodesReport.prototype = {
            ...
            var elems = GlobalUtilities.create_nested_elements([
                {
                    ...
                    Childs: [
                        ...
                        {
                            Type: "div", Class: "small-6 medium-6 large-6", Style: "padding-" + RV_Float + ":1rem;",
                            Childs: [
                                {
                                    Type: "select", Class: "rv-input", Name: "countSelect",
                                    Style: "font-size:0.6rem; width:6rem;",
                                    Childs: [
                                        {
                                            Type: "option",
