(function () {
    ...
    FormsManager.prototype = {
        initialize: function () {
            ...
            var elems = GlobalUtilities.create_nested_elements([
                {
                    ...
                    Childs: [
                        {
                            Type: "div", Class: "RevTextAlign RevDirection", Name: "archiveContainer",
                ...
                { Type: "div", Class: "small-12 medium-12 large-12", Name: "forms" },
            ...
            that.Interface.ArchiveLabelContainer = elems["archiveContainer"];
                    ...
                    OnActionCall: function (name, callback) {
                        ...
                        FGAPI.CreateForm({
                            ...
                            ResponseHandler: function (result) {
                                ...
                                else if (result.FormID) that.add_item(container, result.Form, true, false);
        ...
        show_edit_panel: function (container) {
            ...
            jQuery(that.Interface.ArchiveLabelContainer).fadeOut(200);
        ...
        hide_edit_panel: function () {
            ...
            jQuery(that.Interface.FormDetail).fadeOut(200, () => {
                jQuery(that.Interface.ArchiveLabelContainer).fadeIn(500);
