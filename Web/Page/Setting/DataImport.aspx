...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript" src="../../Script/API/DocsAPI.js"></script>
    <script type="text/javascript" src="../../Script/API/DIAPI.js"></script>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        (function () {
            var container = document.getElementById("dataimport");
