...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript" src="../../Script/USR/ApplicationsManager.js?v=28"></script>

    <script type="text/javascript" src="../../Script/CKEditor5/ckeditor.js"></script>
    <script type="text/javascript" src="../../Script/CKEditor5/translations/fa.js"></script>
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <!--
    <div style="padding:0 4vw;"><div id="editor">Ramin Yavari</div></div>

    <div style="margin:2rem; display:flex; flex-flow:row; justify-content:center;">
